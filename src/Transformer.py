class Transformer:
    ...
    @staticmethod
    def transform_tournament_generic(file, tn_name_length):
        """
        Transforms "Birthday Freeroll" tournaments. Returns transformed file.
        """
        f = open(file)
        new_file = []
        player_names = []
        ...
        for line in f:
            ...
            if split_l:
                ...
                if split_l[0] == "Winamax":
                    ...
                    new_line.append(split_l[12+tn_name_length])
                    new_line.append("-")
                    new_line.append("Holdem")
                    new_line.append("no")
                    new_line.append("limit")
                    index = split_l[17+tn_name_length].find("/")
                    str_stakes = split_l[17+tn_name_length][index + 1:]
